...
// En esta clase se crean las funciones y métodos principales para correr el juego.  
// Para mostrar los gráficos, la pelota, la plataforma, los bloques y demas se escriben los métodos en esta clase.
// En esta clase se crea la lógica del del juego, en donde todos los datos con respecto a la ubicación de la pelota
// y la ubicación de la plataforma son implementados.
...
public class SalaJuego extends JPanel implements KeyListener, ActionListener  {
	...
	public SalaJuego() {
		mapa = new GeneradorMapa(4, 7); //Se crea el objeto mapa, el cual conecta la clase GeneradorMapa con la clase SalaJuego
		addKeyListener(this);
		setFocusable(true);
	...
	//En éste método se establece una de lasfuncionalidades principales que es conectarel teclado y el mouese con nuestro juego
